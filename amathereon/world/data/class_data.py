...
class Classes():
	...
	Rogue: CharacterClass = CharacterClass(
		...
		inventory = [("dagger","silk_gloves"),"cap","boots"],
	...
	Warrior: CharacterClass = CharacterClass(
		...
		languages = [],
		inventory = [("shortsword","axe"),"boots"],
	...
	Outlander: CharacterClass = CharacterClass(
		...
		languages = [],
		inventory = [("dagger","club"),"wool_shirt"],
	...
	Mage: CharacterClass = CharacterClass(
		...
		languages = [],
		inventory = [("quarterstaff",["straw_hat","hillrockian_gold_penny"])],
	...
	Specialist: CharacterClass = CharacterClass(
		...
		specials = ["Select a Skill", "Select a Skill", "Select a Skill", "Select a Skill", "Select a Skill", "Select a Skill"],
		languages = [],
		inventory = [("quarterstaff",["club","hillrockian_gold_penny"]),"cotton_shirt"],
	...
	buildNarrowClass(Rogue, Thief,
		...
		languages = [],
		inventory = ["cotton_shirt","leather_coat",("cotton_pants","denim_pants"),("leather_gloves","hillrockian_silver_penny"),"wool_socks"],
	...
	buildNarrowClass(Rogue, Assassin,
		...
		languages = [],
		inventory = ["throwing_knife","cotton_shirt","leather_coat","leather_gloves",("cotton_pants","denim_pants"),"wool_socks"],
	...
	buildNarrowClass(Rogue, ConArtist,
		...
		languages = [],
		inventory = ["silk_shirt",("rapier",["throwing_knife","throwing_knife","silk_gloves"]),"silk_socks",("silk_leggings",["cotton_pants","hillrockian_gold_penny"])],
	...
	buildNarrowClass(Rogue, Spy,
		...
		specials = ["Stealth Expert"],
		languages = [],
		inventory = ["cotton_shirt",("cotton_pants","denim_pants","leather_pants"),"wool_socks","hillrockian_gold_penny"],
	...
	buildNarrowClass(Warrior, Brawler,
		...
		languages = [],
		inventory = ["wool_shirt",("straw_hat","cap"),(["denim_pants","hillrockian_silver_penny"],"leather_pants"),"wool_socks"],
	...
	buildNarrowClass(Warrior, Knight,
		...
		languages = [],
		inventory = [("armet","lamellar_helmet"),"cap",(["cap","hillrockian_gold_penny"],"chain_hood"),"cotton_shirt","leather_coat",("chestplate","laminar_mail_shirt","shell_plate"),("spear","longsword","warhammer"),"shield",(["leather_pants","hillrockian_gold_mark"],["cotton_pants","chain_leggings"]),"wool_socks"],
	...
	buildNarrowClass(Warrior, Soldier,
		...
		specials = ["Veteran"],
		languages = [],
		inventory = ["barbute","cap","cap","wool_shirt","leather_coat","chain_shirt","pike"],
	...
	buildNarrowClass(Warrior, Paladin,
		...
		specials = ["Divination"],
		languages = [],
		inventory = ["armet","cap","chain_hood","silk_shirt","leather_coat","chestplate","lance","rapier"],
	...
	buildNarrowClass(Outlander, Ranger,
		...
		specials = ["Tracking"],
		languages = [],
		inventory = ["cap","wool_shirt","leather_coat"],
	...
	buildNarrowClass(Outlander, Barbarian,
		...
		specials = ["Calm Fury"],
		languages = [],
		inventory = ["straw_hat","wool_shirt","axe"],
	...
	buildNarrowClass(Outlander, Druid,
		...
		specials = ["Druidcraft"],
		languages = ["Druidic"],
		inventory = ["cap","wool_shirt","dagger"],
