...
class Classes():
	...
	buildNarrowClass(Rogue, Thief,
		...
		languages = [],
		inventory = ["cap","cotton_shirt","leather_coat"],
	...
	buildNarrowClass(Rogue, Assassin,
		...
		languages = [],
		inventory = ["throwing_knife","cotton_shirt","leather_coat"],
	...
	buildNarrowClass(Warrior, Knight,
		...
		languages = [],
		inventory = ["armet","cap","chain_hood","cotton_shirt","leather_coat","chestplate","spear","shield"],
